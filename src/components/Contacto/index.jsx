...
export const contacto = () => {
  return (
    <h1 className='mt-5 px-4'>aqui van los datos para contacto</h1>
    /* <div>
      <section className="ftco-section">
        ...
        <input type="text" className="form-control" name="subject" id="subject" placeholder="Subject" spellcheck="false" data-ms-editor="true"/>
        </div>
        </div>
        <div className="col-md-12">
        <div className="form-group">
        <label className="label" for="#">Message</label>
        <textarea name="message" className="form-control" id="message" cols="30" rows="4" placeholder="Message" spellcheck="false" data-ms-editor="true"></textarea>
        </div>
        </div>
        <div className="col-md-12">
        <div className="form-group">
